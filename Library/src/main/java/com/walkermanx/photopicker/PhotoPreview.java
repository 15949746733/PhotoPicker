...
public class PhotoPreview {
    ...
    public static class PhotoPreviewBuilder {
         ...
         * @param requestCode requestCode for result
         */
        public void start(@NonNull Fragment fragment, int requestCode, @Nullable Bundle options) {
        ...
        public void start(@NonNull Fragment fragment, @Nullable Bundle options) {
